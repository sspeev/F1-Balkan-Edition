...
public class MentalCommands : MonoBehaviour
{
    ...
    private readonly string _appVersion = "3.6.9 ";
    //private readonly string _headSetId = 
    ...
    [SerializeField]
    public InputField HeadsetId;// headsetId

    [SerializeField]
    public InputField RecordTitle;// record Title

    [SerializeField]
    public InputField RecordDescription;// record description

    [SerializeField]
    public InputField ProfileName;// headsetId
    ...
    public void onStartRecordBtnClick()
    {
        ...
        {
            Debug.LogError("Can not start a record because there is no active session or record title is empty.");
        }
    }
